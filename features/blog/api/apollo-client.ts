...
export const STRAPI_URL = process.env.NEXT_PUBLIC_STRAPI_URL || 'https://cms.silvana.one'
...
function createApolloClientInstance() {
...
export { createApolloClientInstance as createApolloClient }
